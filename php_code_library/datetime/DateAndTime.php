...
// This class may be depricated by php's own DateTime. Some of the functionality
// involving php's DateTime is experimental
...
class DateAndTime {
    ...
    /* {{{Constructor
     */
    function DateAndTime($string = null, $time = null) {
     ...
     */
    function getDate() {
        return new DateAndTime(date("Y-m-d", $this->time));
    }//}}}
     ...
     */
    function today() {
        return new DateAndTime(date("Y-m-d"));
    }//}}}
    ...
    function addDays($days) {
        return new DateAndTime(null, mktime(
            date("H", $this->time),
            date("i", $this->time),
            date("s", $this->time),
            date("m", $this->time),
